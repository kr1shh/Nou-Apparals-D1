        ...
        <div class="route-squares">
            ...
            <div class="rout-path">
                ...
                <svg width="407" height="1065" viewBox="0 0 407 1065" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.49992 1.5C1.49992 1.5 490.503 143.771 392 348C317 503.5 -11.2094 551.109 1.49992 724C14.2092 896.891 287.5 1063.5 287.5 1063.5" stroke="#393939" stroke-width="2"/>
                    </svg>                        
            </div>
            <div class="r-path-desk">
                <svg width="632" height="1002" viewBox="0 0 632 1002" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.2" d="M25.5002 1C245 1 129.5 77.5004 517 227.5C904.5 377.5 185 440 32.0001 630C-121 820 338 1000.5 523 1000.5" stroke="white" stroke-width="2"/>
                    </svg>                        
            </div>
            </div>
